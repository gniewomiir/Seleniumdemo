...
public class SeleniumHelper {
    ...
    public static MediaEntityModelProvider getScreenshot_(WebDriver driver) throws IOException {
    ...
    private static String takeScreenshot(WebDriver driver) throws IOException {
        ...
        String path = "src/test/java/resources/screenshots/schreenshot" + randomNumber + ".png";
